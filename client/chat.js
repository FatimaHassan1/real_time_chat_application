...
//With socket.emit() we're emitting (sending a message) to our server. The first parameter is the event name and the second parameter is the data we're sending, in this case, just the username
// emit event to server with the user's name
socket.emit("new-connection", { username });

//we capture events sent from the server to the clients
